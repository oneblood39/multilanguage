        ...
        <div class="col-lg-12" style="margin-top: 10px;">
            ...
            if(!empty($users))
            {
                ...
                foreach($users as $user)
                {
                   ...
                   if($current_user->id != $user->id) echo anchor('admin/users/edit/'.$user->id,'<span class="glyphicon glyphicon-pencil"></span>').' '.anchor('admin/users/pasifet/'.$user->id,'<span class="glyphicon glyphicon-chevron-down"></span>');
                    else echo '&nbsp;';
                    echo '</td>';
                    echo '</tr>';
                }
