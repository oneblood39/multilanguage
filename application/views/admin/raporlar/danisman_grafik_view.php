...
<div class="container" style="margin-top:60px;">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <?php
            echo anchor('admin/raporlar/raporlar/danisman_grafik/clear-cache','Yeniden Yükle','class="btn btn-primary"');
            ?>

    
         <table class="table table-hover table-bordered table-condensed">

<a href="<?php echo site_url('admin/raporlar/raporlar/danisman_grafik2');?>" class="btn btn-primary">Danışman - Seans Ortalama</a>
 </table>


<?php  echo '<form method="post" action="'.site_url('admin/raporlar/raporlar/danisman_grafik').'">'; ?>
...
$sql="select concat(DanismanAd,' ',DanismanSoyad) as danisman, count(randevuID) as seansSayisi,count(distinct danisanID) as danisanSayisi
from vwrandevu
...
$results = $this->db->query($sql)->result();
  ...
  foreach ($results as $result) {
    ...
    $sayi=$result->seansSayisi;
    $donusen=$result->danisanSayisi;
 
array_push($dataPoints1, array("label"=> $danisman, "y"=> $sayi));
array_push($dataPoints2, array("label"=> $danisman, "y"=> $donusen));
...
<h3><center>Danışman - Seans Raporu</center></h3>
