...
if($ofis=='3') { 
$sql="Select * From vwcagri where (ofisID=1 or ofisID=2) and dateCreated between "."'".$baslangic."'"." and "."'".$bitis."' order by cagriID desc";
} else { 
$sql="Select * From vwcagri where ofisID=".$ofis." and dateCreated between "."'".$baslangic."'"." and "."'".$bitis."' order by cagriID desc";
 }
