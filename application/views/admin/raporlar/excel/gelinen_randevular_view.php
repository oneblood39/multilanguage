...
//$sql ="SELECT * FROM vwrandevu where ofisID=".$ofis." and randevuBaslangicTarihSaat between ".$baslangic." and ".$bitis."  order by randevuID";
  if($ofis=='3') {
  $sql="Select * From vwrandevu where (RandevuDurumID=1 or RandevuDurumID=2 or RandevuDurumID=4 or RandevuDurumID=6 ) and (ofisID=1 or ofisID=2)  and randevuBaslangicTarihSaat between "."'".$baslangic."'"." and "."'".$bitis."' order by DanismanAd";
  } else { 
  $sql="Select * From vwrandevu where (RandevuDurumID=1 or RandevuDurumID=2 or RandevuDurumID=4 or RandevuDurumID=6 ) and ofisID=".$ofis." and randevuBaslangicTarihSaat between "."'".$baslangic."'"." and "."'".$bitis."' order by DanismanAd";
  }
