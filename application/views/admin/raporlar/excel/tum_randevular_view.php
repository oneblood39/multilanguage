...
if($ofis=='3') { 
$sql="Select * From vwrandevu where (ofisID=1 or ofisID=2) and randevuBaslangicTarihSaat between "."'".$baslangic."'"." and "."'".$bitis."' order by DanismanAd";
} else { 
$sql="Select * From vwrandevu where ofisID=".$ofis." and randevuBaslangicTarihSaat between "."'".$baslangic."'"." and "."'".$bitis."' order by DanismanAd";
 }
