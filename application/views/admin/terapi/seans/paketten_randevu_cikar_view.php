 ...
 <div class="col-lg-2 col-lg-offset-2">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-lg-offset-4">
            <h2>Paketten Randevu Çıkar</h2>



<?php echo '<form id="form1" method="post" action="';echo site_url('admin/terapi/seans/pakettenrandevusil');echo '">';
...
<?php 
    $sql = "SELECT * FROM vwrandevu  where paketID IS NOT NULL and (danisanID=".$danisan_id.')';
...
<input type="submit" class="btn btn-primary" value="Randevuları Paketten Çıkar">
