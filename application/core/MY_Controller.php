...
{ ///default controller sayfası değişiklik yaparsanız controllerlar patlar!!!
    public $website;
...
class Admin_Controller extends MY_Controller
{
	...
	protected function render($the_view = NULL, $template = 'admin_master',$data=array())
	{
		//echo "testtttt";
 // $this->data['before_head'] = 'ssssssssssssssssssssssssssssssssssssss';
        parent::render($the_view, $template, $this->data);
...
class Public_Controller extends MY_Controller
{
    ...
    protected function render($the_view = NULL, $template = 'public_master')     //////$data = array() yazmak gerekebilir
    {
