...
class Dictionary extends Admin_Controller
{
	...
	public function index($language_slug = NULL) //dil kodları default ayarları
    {
    ...
    public function add_word_from_content($content_id,$language_slug,$word)  ///anahtar kelime ekleme
    {
        $this->load->model('dictionary_model');
        $word = urldecode($word);
...
$(\'#root_word_options\').textext({
    ...
    public function autosuggest($language_slug = NULL, $q = NULL)  //otomatik önerme
    {
        $language_slug = (isset($language_slug) && array_key_exists($language_slug, $this->langs)) ? $language_slug : $this->current_lang;
        if(isset($_GET['q']))
        {
    ...
    public function edit($language_slug, $word_id) ///otomatik önerme ayarları
    {
        $this->load->model('dictionary_model');
        $this->data['language_slug'] = $language_slug;
...
$(\'#root_word_options\').textext({
    ...
    public function delete($language_slug, $word_id) ///önerme kelimesi kaldır
    {
        $this->load->model('dictionary_model');
        //$this->data['language_slug'] = $language_slug;
        $word = $this->dictionary_model->get($word_id);
