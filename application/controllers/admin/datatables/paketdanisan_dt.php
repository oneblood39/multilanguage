...
class Paketdanisan_dt extends Admin_Controller
{
...
print_r($datasessionmevcut);
    ...
    // if($search){
       if($cat->danisanID>0){  
        ...
        "  <a href=\"'.site_url('admin/terapi/seans/paketata/').$cat->danisanID.'/'.$paket.'\"><span title=\"danışan bilgileri\" class=\"glyphicon glyphicon-random\"></span></a>"],';
  //print_r($data);
