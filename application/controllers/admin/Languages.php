...
class Languages extends Admin_Controller
{
	...
	public function update($language_id = NULL) ///sistem dilini güncelle
	{
		$rules = $this->language_model->rules;
	...
	public function delete($language_id) //sistem dilini silme
	{
