...
class User extends MY_Controller
{
    ...
    public function login()  ///bildiğin login:)
    {
    ...
    public function profile() ////kullanıcı profil sayfası
    {
     $mail=$this->ion_auth->user()->row()->email;
       if($mail=="") 
        {
            $this->postal->add('Ops yavaş! Önce bir mail-şifre alalım!','error');
            redirect('admin');
        }
    ...
    public function logout()   ///bildiğin logout:)
    {
        //$this->ion_auth->logout(); //Çıkış işlemi yapmadan çıkış başarılı yazısı gelmesin diye kontrol yaptım.
